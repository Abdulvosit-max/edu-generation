...
from .views import ResourceViewSet, AIGenerateView, ImageGenerateView, TTSView, SubscriptionRequestCreateView, SubscriptionStatusView
...
urlpatterns = [
    ...
    path('ai/tts/', TTSView.as_view(), name='ai-tts'),

...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-edu-gen-secret-key-change-this-in-prod')
...
if DB_ENGINE == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'edu_gen'),
...
# CORS: frontend domainlarini env dan o'qi
